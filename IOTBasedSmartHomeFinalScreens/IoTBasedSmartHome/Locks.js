import {
  ...
  useFocusEffect(
    ...
    }, [compartmentId, List_Compartment_lock_by_compartment_id])
  );
    ...
    return (
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={[styles.container]}>
        <View style={[styles.navbar]}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={[styles.navbarText, { marginRight: 25 }]}>Locks</Text>
          </View>
        </View>
            ...
            <View>
              ...
              <View style={{ padding: '10%', backgroundColor: '' }}>
                ...
                <View style={{ justifyContent: 'center', padding: 50, borderRadius: 20, alignItems: 'center', marginTop: 10, backgroundColor: 'lightgray' }}>
                  ...
                  <Text style={[styles.listText, { color: 'black', fontSize: 15, marginLeft: 6, marginTop: 15 }]}>Please press + icon to add Locks</Text>
                </View>
              </View>
            </View>
          }
